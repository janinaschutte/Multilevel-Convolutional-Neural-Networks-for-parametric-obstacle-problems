...
class LossFunct():
    ...
    def get_norm_sq(self, x, level):
        ...
        batch_size = x.shape[0]
        x = x.view(batch_size, -1)[:, self.orderings[level].to(x.device)].permute(1, 0)
...
def perform_run(problem, param_dimension, num_corrections, num_samples_per_level, num_epochs, batch_size,
    ...
    print('training',saving_path,' on', device)
...
if __name__ == "__main__":
    num_corrections = 7
    num_samples_per_level = num_corrections*[10000]
    num_params_per_level = [10e+5 for _ in range(2)] + [8e+5 for i in range(num_corrections-2)]#[8e+5 for i in range(num_corrections)]
    print("num_params_per_level: ", num_params_per_level)
    num_epochs = 80#40#20
    
    # perform_run('obstacle', 11, num_corrections, num_samples_per_level, num_epochs, 24,
    #             1024, 1024, num_params_per_level, True, True, './code/FinalConvModel/ModelSaves',
    #             'obstacle11variable_big_0', torch.device('cuda:0'), './code/FinalConvModel/Data/obstacle11variable')
    
    # perform_run('obstacle', 10, num_corrections, num_samples_per_level, num_epochs, 24,
    #             1024, 1024, num_params_per_level, False, True, './code/FinalConvModel/ModelSaves',
    #             'obstacle10constant4', torch.device('cuda:0'), './code/FinalConvModel/Data/obstacle10constant')

    # run_name = 'obstacle51variable_4'
    # print("run name", run_name)
    # perform_run('obstacle', 51, num_corrections, num_samples_per_level, num_epochs, 24,
    #             1024, 1024, num_params_per_level, True, True, './code/FinalConvModel/ModelSaves',
    #             run_name, torch.device('cuda:3'), './code/FinalConvModel/Data/obstacle51variable')
    
    # run_name = 'obstacle50constant_4'
    # print("run name", run_name)
    # perform_run('obstacle', 50, num_corrections, num_samples_per_level, num_epochs, 24,
    #             1024, 1024, num_params_per_level, False, True, './code/FinalConvModel/ModelSaves',
    #             run_name, torch.device('cuda:2'), './code/FinalConvModel/Data/obstacle50constant')

    # run_name = 'obstacle220rough_4'
    # print("run name", run_name)
    # perform_run('obstacle', 220, num_corrections, num_samples_per_level, num_epochs, 24,
    #             1024, 1024, num_params_per_level, False, True, './code/FinalConvModel/ModelSaves',
    #             run_name, torch.device('cuda:0'), './code/FinalConvModel/Data/obstacle220rough_')

    run_name = 'obstacle100rough_4'
    print("run name", run_name)
    perform_run('obstacle', 220, num_corrections, num_samples_per_level, num_epochs, 24,
                1024, 1024, num_params_per_level, False, True, './code/FinalConvModel/ModelSaves',
                run_name, torch.device('cuda:1'), './code/FinalConvModel/Data/obstacle100rough')
    ...
    """print("3 levels")
    num_corrections = 3
    perform_run('obstacle', 11, num_corrections, num_corrections*[100], 20, 24,
    ...
    # num_corrections = 7
    # perform_run('obstacle', 11, num_corrections, num_corrections*[10000], 20, 24,
    #             1024, 1024, [8e+5 for i in range(num_corrections)], True, True, './code/FinalConvModel/ModelSaves',
    #             'stefan4variable', torch.device('cuda:0'), './code/FinalConvModel/Data/stefan4variable')

    # print("cuda", torch.cuda.is_available(), torch.cuda.device_count(), torch.cuda.current_device())
    # start = time.time()
    # print("start", start)
    # num_corrections = 7
    # perform_run('obstacle', 50, num_corrections, num_corrections*[10000], 20, 24,
    #             1024, 1024, [8e+5 for i in range(num_corrections)], False, True, './code/FinalConvModel/ModelSaves',
    #             'obstacle50constant_4', torch.device('cuda:2'), './code/FinalConvModel/Data/obstacle50constant')
    # end = time.time()
    ...
    # print("start", start)
    # num_corrections = 7
    # perform_run('obstacle', 51, num_corrections, num_corrections*[10000], 20, 24,
    #             1024, 1024, [8e+5 for i in range(num_corrections)], True, True, './code/FinalConvModel/ModelSaves',
    #             'obstacle51variable_10', torch.device('cuda:0'), './code/FinalConvModel/Data/obstacle51variable')
    # end = time.time()
    # print("duration", end - start)


    # num_corrections = 7
    # perform_run('obstacle', 4, num_corrections, num_corrections*[10000], 20, 24,
    #             1024, 1024, [8e+5 for i in range(num_corrections)], True, True, './code/FinalConvModel/ModelSaves',
    #             'stefan4', torch.device('cuda:0'), './code/FinalConvModel/Data/stefan4variable')
    
    # num_corrections = 7
    # perform_run('obstacle', 10, num_corrections, num_corrections*[10000], 20, 24,
    #             1024, 1024, [8e+5 for i in range(num_corrections)], False, True, './code/FinalConvModel/ModelSaves',
    #             'obstacle10constant_4', torch.device('cuda:2'), './code/FinalConvModel/Data/obstacle10constant')
